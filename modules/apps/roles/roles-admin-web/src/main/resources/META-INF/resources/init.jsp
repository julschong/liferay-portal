...
page import="com.liferay.roles.admin.web.internal.servlet.taglib.clay.GroupVerticalCard" %><%@
page import="com.liferay.roles.admin.web.internal.servlet.taglib.clay.OrganizationVerticalCard" %><%@
page import="com.liferay.roles.admin.web.internal.servlet.taglib.clay.UserGroupVerticalCard" %><%@
page import="com.liferay.roles.admin.web.internal.servlet.taglib.clay.UserVerticalCard" %><%@
