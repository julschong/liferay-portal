...
public class UserFacetPortletPreferencesImpl
	...
	public int getFrequencyThreshold() {
		return GetterUtil.getInteger(
			_portletPreferences.getValue(
				UserFacetPortletPreferences.PREFERENCE_KEY_FREQUENCY_THRESHOLD,
				StringPool.BLANK),
			1);
	}
	...
	public int getMaxTerms() {
		return GetterUtil.getInteger(
			_portletPreferences.getValue(
				UserFacetPortletPreferences.PREFERENCE_KEY_MAX_TERMS,
				StringPool.BLANK),
			10);
	}
	...
	public String getOrder() {
		return StringUtil.trim(
			_portletPreferences.getValue(
				UserFacetPortletPreferences.PREFERENCE_KEY_ORDER,
				"count:desc"));
	}
	...
	public String getParameterName() {
		return StringUtil.trim(
			_portletPreferences.getValue(
				UserFacetPortletPreferences.PREFERENCE_KEY_PARAMETER_NAME,
				"user"));
	}
