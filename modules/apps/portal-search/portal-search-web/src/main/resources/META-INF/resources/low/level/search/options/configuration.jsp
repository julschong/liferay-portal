...
>
	...
	<liferay-frontend:edit-form-body>
		...
		>
			...
			<aui:input cssClass="fields-input" name="<%= PortletPreferencesJspUtil.getInputName(LowLevelSearchOptionsPortletPreferences.PREFERENCE_ATTRIBUTES) %>" type="hidden" value="<%= GetterUtil.getString(lowLevelSearchOptionsPortletPreferences.getAttributes()) %>" />
		</liferay-frontend:fieldset>
	</liferay-frontend:edit-form-body>
