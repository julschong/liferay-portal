...
export declare function DropdownColorPicker({ active, colors, fieldLabel, inherited, label, onSetActive, onValueChange, showSelector, small, value, }: Props): JSX.Element;
export {};
