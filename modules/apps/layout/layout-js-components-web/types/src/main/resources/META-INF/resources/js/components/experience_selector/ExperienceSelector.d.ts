...
export default function ExperienceSelector({ disabled, displayType, label, onChangeExperience, segmentsExperiences, selectedSegmentsExperience, ...otherProps }: ExperienceSelectorProps): JSX.Element;
export {};
