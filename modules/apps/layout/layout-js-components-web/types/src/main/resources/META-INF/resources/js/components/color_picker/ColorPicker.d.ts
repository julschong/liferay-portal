...
export default function ColorPicker({ activeItemId, canDetachTokenValues, defaultTokenLabel, defaultTokenValue, editedTokenValues, field, onValueSelect, showLabel, tokenValues, restoreButtonLabel, value, }: Props): JSX.Element;
export {};
