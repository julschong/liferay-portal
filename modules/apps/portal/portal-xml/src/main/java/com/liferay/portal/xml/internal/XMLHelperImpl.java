...
package com.liferay.portal.xml.internal;
...
public class XMLHelperImpl implements XMLHelper {
	...
	public String fromCompactSafe(String xml) {
		return StringUtil.replace(xml, "[$NEW_LINE$]", StringPool.NEW_LINE);
	}

	public String stripInvalidChars(String xml) {
	...
	public String toCompactSafe(String xml) {
	...
	public String toString(Node node, String indent) throws IOException {
