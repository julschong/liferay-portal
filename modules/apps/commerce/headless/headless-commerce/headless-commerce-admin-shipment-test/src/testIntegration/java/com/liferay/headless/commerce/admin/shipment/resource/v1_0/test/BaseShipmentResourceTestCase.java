		...
		if (entityFieldName.equals("createDate")) {
			if (operator.equals("between")) {
				...
				sb.append(
					_dateFormat.format(
						addToDate(
							shipment.getCreateDate(), Calendar.SECOND, -2)));
				sb.append(" and ");
				sb.append(entityFieldName);
				sb.append(" lt ");
				sb.append(
		...
		if (entityFieldName.equals("expectedDate")) {
			if (operator.equals("between")) {
				...
				sb.append(
					_dateFormat.format(
						addToDate(
							shipment.getExpectedDate(), Calendar.SECOND, -2)));
				sb.append(" and ");
				sb.append(entityFieldName);
				sb.append(" lt ");
				sb.append(
		...
		if (entityFieldName.equals("modifiedDate")) {
			if (operator.equals("between")) {
				...
				sb.append(
					_dateFormat.format(
						addToDate(
							shipment.getModifiedDate(), Calendar.SECOND, -2)));
				sb.append(" and ");
				sb.append(entityFieldName);
				sb.append(" lt ");
				sb.append(
		...
		if (entityFieldName.equals("shippingDate")) {
			if (operator.equals("between")) {
				...
				sb.append(
					_dateFormat.format(
						addToDate(
							shipment.getShippingDate(), Calendar.SECOND, -2)));
				sb.append(" and ");
				sb.append(entityFieldName);
				sb.append(" lt ");
				sb.append(
