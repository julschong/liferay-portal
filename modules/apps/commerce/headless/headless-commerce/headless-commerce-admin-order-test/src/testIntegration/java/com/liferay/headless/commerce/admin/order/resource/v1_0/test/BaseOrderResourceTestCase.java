	...
	protected String getFilterString(
		...
		if (entityFieldName.equals("createDate")) {
			if (operator.equals("between")) {
				...
				sb.append(
					_dateFormat.format(
						addToDate(order.getCreateDate(), Calendar.SECOND, -2)));
				sb.append(" and ");
				sb.append(entityFieldName);
				sb.append(" lt ");
				sb.append(
		...
		if (entityFieldName.equals("lastPriceUpdateDate")) {
			if (operator.equals("between")) {
				...
				sb.append(
					_dateFormat.format(
						addToDate(
							order.getLastPriceUpdateDate(), Calendar.SECOND,
							-2)));
				sb.append(" and ");
				sb.append(entityFieldName);
				sb.append(" lt ");
		...
		if (entityFieldName.equals("modifiedDate")) {
			if (operator.equals("between")) {
				...
				sb.append(
					_dateFormat.format(
						addToDate(
							order.getModifiedDate(), Calendar.SECOND, -2)));
				sb.append(" and ");
				sb.append(entityFieldName);
				sb.append(" lt ");
				sb.append(
		...
		if (entityFieldName.equals("orderDate")) {
			if (operator.equals("between")) {
				...
				sb.append(
					_dateFormat.format(
						addToDate(order.getOrderDate(), Calendar.SECOND, -2)));
				sb.append(" and ");
				sb.append(entityFieldName);
				sb.append(" lt ");
				sb.append(
		...
		if (entityFieldName.equals("requestedDeliveryDate")) {
			if (operator.equals("between")) {
				...
				sb.append(
					_dateFormat.format(
						addToDate(
							order.getRequestedDeliveryDate(), Calendar.SECOND,
							-2)));
				sb.append(" and ");
				sb.append(entityFieldName);
				sb.append(" lt ");
