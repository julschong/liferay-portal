		...
		if (entityFieldName.equals("displayDate")) {
			if (operator.equals("between")) {
				...
				sb.append(
					_dateFormat.format(
						addToDate(
							discount.getDisplayDate(), Calendar.SECOND, -2)));
				sb.append(" and ");
				sb.append(entityFieldName);
				sb.append(" lt ");
				sb.append(
		...
		if (entityFieldName.equals("expirationDate")) {
			if (operator.equals("between")) {
				...
				sb.append(
					_dateFormat.format(
						addToDate(
							discount.getExpirationDate(), Calendar.SECOND,
							-2)));
				sb.append(" and ");
				sb.append(entityFieldName);
				sb.append(" lt ");
				sb.append(
					_dateFormat.format(
						addToDate(
							discount.getExpirationDate(), Calendar.SECOND, 2)));
				sb.append(")");
			}
			else {
				sb.append(entityFieldName);
		...
		if (entityFieldName.equals("modifiedDate")) {
			if (operator.equals("between")) {
				...
				sb.append(
					_dateFormat.format(
						addToDate(
							discount.getModifiedDate(), Calendar.SECOND, -2)));
				sb.append(" and ");
				sb.append(entityFieldName);
				sb.append(" lt ");
				sb.append(
