		...
		if (entityFieldName.equals("birthDate")) {
			if (operator.equals("between")) {
				...
				sb.append(
					_dateFormat.format(
						addToDate(
							userAccount.getBirthDate(), Calendar.SECOND, -2)));
				sb.append(" and ");
				sb.append(entityFieldName);
				sb.append(" lt ");
				sb.append(
		...
		if (entityFieldName.equals("dateCreated")) {
			if (operator.equals("between")) {
				...
				sb.append(
					_dateFormat.format(
						addToDate(
							userAccount.getDateCreated(), Calendar.SECOND,
							-2)));
				sb.append(" and ");
				sb.append(entityFieldName);
				sb.append(" lt ");
				sb.append(
					_dateFormat.format(
						addToDate(
							userAccount.getDateCreated(), Calendar.SECOND, 2)));
				sb.append(")");
			}
			else {
				sb.append(entityFieldName);
		...
		if (entityFieldName.equals("dateModified")) {
			if (operator.equals("between")) {
				...
				sb.append(
					_dateFormat.format(
						addToDate(
							userAccount.getDateModified(), Calendar.SECOND,
							-2)));
				sb.append(" and ");
				sb.append(entityFieldName);
				sb.append(" lt ");
		...
		if (entityFieldName.equals("lastLoginDate")) {
			if (operator.equals("between")) {
				...
				sb.append(
					_dateFormat.format(
						addToDate(
							userAccount.getLastLoginDate(), Calendar.SECOND,
							-2)));
				sb.append(" and ");
				sb.append(entityFieldName);
				sb.append(" lt ");
