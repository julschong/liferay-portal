		...
		if (entityFieldName.equals("dateCreated")) {
			if (operator.equals("between")) {
				...
				sb.append(
					_dateFormat.format(
						addToDate(
							formRecord.getDateCreated(), Calendar.SECOND, -2)));
				sb.append(" and ");
				sb.append(entityFieldName);
				sb.append(" lt ");
				sb.append(
		...
		if (entityFieldName.equals("dateModified")) {
			if (operator.equals("between")) {
				...
				sb.append(
					_dateFormat.format(
						addToDate(
							formRecord.getDateModified(), Calendar.SECOND,
							-2)));
				sb.append(" and ");
				sb.append(entityFieldName);
				sb.append(" lt ");
				sb.append(
					_dateFormat.format(
						addToDate(
							formRecord.getDateModified(), Calendar.SECOND, 2)));
				sb.append(")");
			}
			else {
				sb.append(entityFieldName);
		...
		if (entityFieldName.equals("datePublished")) {
			if (operator.equals("between")) {
				...
				sb.append(
					_dateFormat.format(
						addToDate(
							formRecord.getDatePublished(), Calendar.SECOND,
							-2)));
				sb.append(" and ");
				sb.append(entityFieldName);
				sb.append(" lt ");
