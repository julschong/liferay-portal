...
public class AMImageConfigurationUpgradeProcessTest {
	...
	public void testRunningUpgrade() throws Exception {
		String testConfigurationPid =
			"com.liferay.adaptive.media.image.internal.configuration." +
				"AMImageConfiguration~Test";

		ConfigurationTestUtil.saveConfiguration(
			testConfigurationPid,
		...
		Configuration configuration = _configurationAdmin.getConfiguration(
			testConfigurationPid, StringPool.QUESTION);
		...
		ConfigurationTestUtil.deleteConfiguration(testConfigurationPid);
	}
