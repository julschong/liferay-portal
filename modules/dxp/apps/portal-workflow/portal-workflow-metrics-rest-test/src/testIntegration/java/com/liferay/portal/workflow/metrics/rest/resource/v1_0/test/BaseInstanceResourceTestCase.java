		...
		if (entityFieldName.equals("dateCompletion")) {
			if (operator.equals("between")) {
				...
				sb.append(
					_dateFormat.format(
						addToDate(
							instance.getDateCompletion(), Calendar.SECOND,
							-2)));
				sb.append(" and ");
				sb.append(entityFieldName);
				sb.append(" lt ");
				sb.append(
					_dateFormat.format(
						addToDate(
							instance.getDateCompletion(), Calendar.SECOND, 2)));
				sb.append(")");
			}
			else {
				sb.append(entityFieldName);
		...
		if (entityFieldName.equals("dateCreated")) {
			if (operator.equals("between")) {
				...
				sb.append(
					_dateFormat.format(
						addToDate(
							instance.getDateCreated(), Calendar.SECOND, -2)));
				sb.append(" and ");
				sb.append(entityFieldName);
				sb.append(" lt ");
				sb.append(
		...
		if (entityFieldName.equals("dateModified")) {
			if (operator.equals("between")) {
				...
				sb.append(
					_dateFormat.format(
						addToDate(
							instance.getDateModified(), Calendar.SECOND, -2)));
				sb.append(" and ");
				sb.append(entityFieldName);
				sb.append(" lt ");
				sb.append(
