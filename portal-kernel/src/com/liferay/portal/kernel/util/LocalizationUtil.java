...
public class LocalizationUtil {
	...
	private static void _close(XMLStreamWriter xmlStreamWriter) {
		if (xmlStreamWriter != null) {
			try {
				xmlStreamWriter.close();
			}
	...
	private static String _getDefaultLocalizedName(String name) {
		String defaultLanguageId = LocaleUtil.toLanguageId(
			LocaleUtil.getSiteDefault());
	...
	private static String _getLocalization(
	...
	private static final Map<String, Map<Tuple, String>> _cache =
